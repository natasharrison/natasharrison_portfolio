...
function About() {
  return (
    ...
    <div className="About-Content">
      ...
      <p> She lives in Phoenix, AZ with her fiancé, Joey Murata, and their two (fat) cats, Cocoa and Louis. She runs on coffee, lives to travel, and enjoys quality time with family, friends and nature.</p>
    </div>
    </section>
  );
}
